...
class Tello:
    def __init__(self, tello_ip: str='192.168.10.1', debug: bool=True):
        ...
        self.cap = None#cv2.VideoCapture('udp://'+self.tello_ip+':11111')
    ...
    def _video_thread(self):
        ...
        while self.stream_state:
            ...
            #cv2.putText(frame,'bat: {}, temp: {}C, tof:{}'.format( self.get_battery(),self.get_temp(),self.get_tof()),(10,30),cv2.FONT_HERSHEY_SIMPLEX,0.5,(255,255,255),1,cv2.LINE_AA)
            cv2.imshow('DJI Tello', frame)

            # Video Stream is closed if esself.cape key is pressed
    ...
    def streamon(self):
        #switches on stream service
        #call get_snap or get_video after this
        self.send_command('streamon')
